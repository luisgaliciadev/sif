		...
		<script>		
			...
			{				
				...
				$.ajax(
				{
					type: "POST",
					dataType:"html",
					url: "Sistema/Servicio/FiltroConsulta.PHP",			
					data: Parametros,
					beforeSend: function() 
					{
			...
			function callFormRegistrar(){
				...
				vModal('Sistema/Servicio/FormNuevo.php', 'Registrar Servicio');
			}
			
			function callFormModificar(ID){
				window.parent.parent.Cargando(1);

				vModal('Sistema/Servicio/formModificar.php?&ID='+ID, 'Modificar Servicio');
			}	
			...
			function anular(ID) {
				swal({
					...
					$.ajax({
						type: "POST",
						dataType:"html",
						url: "Sistema/Servicio/ScriptAnular.php",			
						data: parametros,
						beforeSend: function(){
							window.parent.parent.Cargando(1);
						},							
