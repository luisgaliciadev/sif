...
$ID_TP_DOCUMENTO = $_POST["id_tp_documento"];


$vSQL="EXEC [dbo].[SP_CONSULTA_DOCUMENTO] $NRO, $ID_LOCALIDAD, '$ID_TP_DOCUMENTO'";
...
{		
        ...
        {		
			...
			$ESTATUS=odbc_result($resultado,'ESTATUS');
			...
			<div class="col-sm-4">
                <h4 style="'.$style.'">Estatus: <strong>'.utf8_encode(odbc_result($resultado,'DS_ESTATUS')).'</strong></h4>
            </div>
			<div class="col-sm-4">
