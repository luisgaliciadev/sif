...
?> 
			...
			<div class="form-group">
                <label for="SERIE">SERIE DE FACTURA:</label>
                <input id="NB_SERIE" type="text" class="form-control" required>
            </div>
        ...
        <script>
			...
			function Guardar()
			{	                					
				var	NB_SERIE=$("#NB_SERIE").val();
				var	ID_LOCALIDAD=$("#ID_LOCALIDAD").val();
				
				
				Parametros="NB_SERIE="+NB_SERIE+"&ID_LOCALIDAD="+ID_LOCALIDAD;
				...
				$.ajax(
				{
					type: "POST",
					dataType:"html",
					url: "Sistema/Serie/ScriptGuardar.PHP",			
					data: Parametros,	
					beforeSend: function() 
					{
