		...
		<script>		
			...
			{				
				...
				$.ajax(
				{
					type: "POST",
					dataType:"html",
					url: "Sistema/Cuentas/FiltroConsulta.PHP",			
					data: Parametros,
					beforeSend: function() 
					{
			...
			function callFormRegistrar(){
				...
				vModal('Sistema/Cuentas/FormNuevo.php', 'Registrar Moneda Referencia');
			}
			...
			function callFormModificar(ID)
			{
				...
				window.parent.parent.Cargando(1);				
				vModal('Sistema/Cuentas/FormModificar.php?&ID='+ID+'', 'Modificar Moneda Referencia');
			}	

			function anular(ID) {
				swal({
					title: "¿Estas seguro?",
					text: "Estas seguro de anular esta Cuenta!",
					type: "warning",
					...
					$.ajax({
						type: "POST",
						dataType:"html",
						url: "Sistema/Cuentas/ScriptAnular.php",			
						data: parametros,
						beforeSend: function(){
							window.parent.parent.Cargando(1);
						},							
