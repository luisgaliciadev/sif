		...
		<script>		
			...
			{				
				...
				$.ajax(
				{
					type: "POST",
					dataType:"html",
					url: "Sistema/Moneda/FiltroConsulta.PHP",			
					data: Parametros,
					beforeSend: function() 
					{
			...
			function callFormRegistrar(){
				...
				vModal('Sistema/Moneda/FormNuevo.php', 'Registrar Tipo de Moneda');
			}
			...
			function callFormModificar(ID)
			{
				...
				window.parent.parent.Cargando(1);
				vModal('Sistema/Moneda/FormModificar.php?&ID='+ID+'', 'Modificar Tipo de Moneda');
			}	
			...
			function anular(ID) {
				swal({
					...
					$.ajax({
						type: "POST",
						dataType:"html",
						url: "Sistema/Moneda/ScriptAnular.php",			
						data: parametros,
						beforeSend: function(){
							window.parent.parent.Cargando(1);
						},							
