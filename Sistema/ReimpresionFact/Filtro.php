                        ...
                        <div id="detalle" > </div>                        
          				<div id="opciones" class="row">
								<div  class="form-group col-md-2">
									 <button class="form-control btn default-bg" type="button" id="btn-ver-doc" onClick="ver();" >Ver Factura Digital</button>
								</div> 
                      			 <div  class="form-group col-md-2">
                       			 <button class="form-control btn navy-bg" type="button" id="btn-ver-pagos" onClick="ver_fact();" >Ver Factura </button>
                       		</div> 
    ...
    <script>		
        ...
        {   var limpiar = 0;
			...
			{  
					...
					var id_tp_documento = 'B3D59C5C-D757-44C3-B4DA-954141D296A4'
       ...
       function ver_fact()
        {
            ID=$('#id_documento').val();				
            window.open('Sistema/Facturacion/factura.php?ID_DOCUMENTO='+ID);
        }
