		...
		<script>		
			...
			{				
				...
				$.ajax(
				{
					type: "POST",
					dataType:"html",
					url: "Sistema/Documento/FiltroConsulta.PHP",			
					data: Parametros,
					beforeSend: function() 
					{
			...
			function callFormRegistrar(){
				...
				vModal('Sistema/Documento/FormNuevo.php', 'Registrar Tipo Documento');
			}
			...
			function callFormModificar(ID)
			{
				...
				window.parent.parent.Cargando(1);
				vModal('Sistema/Documento/FormModificar.php?&ID='+ID+'', 'Modificar Tipo Documento');
			}	

			function anular(ID) {
				swal({
					title: "¿Estas seguro?",
					text: "Estas seguro de anular este Tipo de Documento!",
					type: "warning",
					...
					$.ajax({
						type: "POST",
						dataType:"html",
						url: "Sistema/Documento/ScriptAnular.php",			
						data: parametros,
						beforeSend: function(){
							window.parent.parent.Cargando(1);
						},							
