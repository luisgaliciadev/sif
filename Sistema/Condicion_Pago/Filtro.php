		...
		<script>		
			...
			{				
				...
				$.ajax(
				{
					type: "POST",
					dataType:"html",
					url: "Sistema/Condicion_Pago/FiltroConsulta.PHP",			
					data: Parametros,
					beforeSend: function() 
					{
			...
			function callFormRegistrar(){
				...
				vModal('Sistema/Condicion_Pago/FormNuevo.php', 'Registrar Condici&oacute;n');
			}
			
			function callFormModificar(ID){
				window.parent.parent.Cargando(1);

				vModal('Sistema/Condicion_Pago/formModificar.php?&ID='+ID, 'Modificar Condici&oacute;n');
			}	

			function anular(ID) {
				swal({
					title: "¿Estas seguro?",
					text: "Estas seguro de anular esta Condici&oacute;n!",
					type: "warning",
					...
					$.ajax({
						type: "POST",
						dataType:"html",
						url: "Sistema/Condicion_Pago/ScriptAnular.php",			
						data: parametros,
						beforeSend: function(){
							window.parent.parent.Cargando(1);
						},							
