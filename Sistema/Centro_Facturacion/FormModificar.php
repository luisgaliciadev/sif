<?php 
	...
	$vSQL="SELECT NB, ID_LOCALIDAD FROM VIEW_TB_CTRO_FACTURACION_LISTADO WHERE ID='$ID'";	
...
?> 
			...
			<div class="form-group">
				...
				<label for="NB_CENTRO">Nombre:</label>
        ...
        <script>
			...
			{	                					
				...
				$.ajax(
				{
					type: "POST",
					dataType:"html",
					url: "Sistema/Centro_Facturacion/ScriptModificar.PHP",			
					data: Parametros,	
					beforeSend: function() 
					{
