		...
		<script>		
			...
			{				
				...
				$.ajax(
				{
					type: "POST",
					dataType:"html",
					url: "Sistema/Centro_Facturacion/FiltroConsulta.PHP",			
					data: Parametros,
					beforeSend: function() 
					{
			...
			function callFormRegistrar(){
				...
				vModal('Sistema/Centro_Facturacion/FormNuevo.php', 'Registrar Nueva Centro de Facturacion');
			}
			...
			function callFormModificar(ID)
			{
				...
				window.parent.parent.Cargando(1);
				vModal('Sistema/Centro_Facturacion/FormModificar.php?&ID='+ID+'', 'Modificar Centro de Facturacion');
			}	

			function anular(ID) {
				swal({
					title: "¿Estas seguro?",
					text: "Estas seguro de anular el Centro de Facturacion Seleccionado!",
					type: "warning",
					...
					$.ajax({
						type: "POST",
						dataType:"html",
						url: "Sistema/Centro_Facturacion/ScriptAnular.php",			
						data: parametros,
						beforeSend: function(){
							window.parent.parent.Cargando(1);
						},							
