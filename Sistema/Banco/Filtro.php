		...
		<script>		
			...
			{				
				...
				$.ajax(
				{
					type: "POST",
					dataType:"html",
					url: "Sistema/Banco/FiltroConsulta.PHP",			
					data: Parametros,
					beforeSend: function() 
					{
			...
			function callFormRegistrar(){
				...
				vModal('Sistema/Banco/FormNuevo.php', 'Registrar Bancos');
			}
			...
			function callFormModificar(ID)
			{
				...
				window.parent.parent.Cargando(1);
				vModal('Sistema/Banco/FormModificar.php?&ID='+ID+'', 'Modificar Bancos');
			}	
			...
			function anular(ID) {
				swal({
					...
					$.ajax({
						type: "POST",
						dataType:"html",
						url: "Sistema/Banco/ScriptAnular.php",			
						data: parametros,
						beforeSend: function(){
							window.parent.parent.Cargando(1);
						},							
