    	...
    	<form id="vForm">
            <div class="row">
                <div class="form-group col-md-12" >
                    <label>Seleccion de numero de Factura y de Control</label>
                    <select class="form-control" id="talonario" name="TALONARIO" required>
                    <option value="">Selecione...</option>   
                    <?php 
                       $vSQL="exec dbo.[SP_TB_TALONARIO_LISTADO]  $ID_USER,'b3d59c5c-d757-44c3-b4da-954141d296a4',$ID_LOCALIDAD";
    ...
    {				
        ...
        $('#guardar_factura').click(function() {
            ...
            swal({
                ...
                text: "¿Desea Generar la Factura? en caso de ser afirmativo este proceso no podra ser revertido",
                type: "warning",
