...
<table  width="100%"  >
    <tr>
        <td style="font-size:10px;">SERIE: '.$res_cab[0]["nb_serie"].'</td>     
    </tr>
    <tr>
        <td style="font-size:10px;">NRO. DOCUMENTO (FACTURA): '.$res_cab[0]["nro_documento"].'</td>     
    </tr>
    <tr>
        <td style="font-size:10px;">FECHA: '.$res_cab[0]["f_emision"].'</td>     
    </tr>
    <tr>
        <td style="font-size:10px;">NRO. PRELIQUIDACION: '.$res_cab[0]["id_preliqu"].'</td>     
    </tr>
    <tr>
        <td style="font-size:10px;">CONDICION DE PAGO: '.$res_cab[0]["nb_condicion_pago"].'</td>     
    </tr>
...
$cuerpo.= $respuesta.$detalle.'<br>
 ...
 <div id="div_footer">
        ...
        <table >
            <tr>
                <td style="font-size:10px;">TIPO DE CAMBIO: '.number_format($res[0]["cambio_moneda"], 2, ",", ".").'
                ...
                <td style="font-size:10px;" width="40%">
                    <table >
                        <tr>
                            <td style="font-size:10px;" align="right"> Subtotal '.$res_cab[0]["simbolo"].': </td>
                            <td style="font-size:10px;" align="right">'.number_format($res[0]["sub_total"], 2, ",", ".").' </td>
                        </tr>
                        <tr >
                            <td style="font-size:10px;" align="right"> Base Imponible '.$res_cab[0]["simbolo"].': </td>
                            <td style="font-size:10px;" align="right">'.number_format($res[0]["monto_nogravado"], 2, ",", ".").'</td>
                        </tr>
                        <tr>
                            <td style="font-size:10px;" align="right"> Monto Exento '.$res_cab[0]["simbolo"].': </td>
                            <td style="font-size:10px;" align="right">'.number_format($res[0]["monto_gravado"], 2, ",", ".").' </td>
                        </tr>
                        <tr>
                            <td style="font-size:10px;" align="right"> IVA '.$res_cab[0]["simbolo"].': </td>
                            <td style="font-size:10px;" align="right">'.number_format($res[0]["monto_iva"], 2, ",", ".").' </td>
                        </tr>
                        <tr >
                            <td style="font-size:10px;" align="right" > TOTAL FACTURA '.$res_cab[0]["simbolo"].': </td>
                            <td style="font-size:10px; border-top:1px solid black;" align="right" >'.number_format($res[0]["total"], 2, ",", ".").' </td>
                        </tr>
                    </table>
            ...
            <tr>
                <td style="font-size:10px;" colspan="2">'.$pagos.'</td>
            </tr>
            <tr>
                <td style="font-size:10px;" colspan="2"><br>Elaborado por: '.$res_cab[0]["usuario_genera"].'<br><br>'.$res_cab[0]["pie_pag"].'</td>
            </tr>
        </table>
