    ...
    {		
        ...
        $pagos .="
            <tr>
                ...
                <td align='right'>".number_format((odbc_result($resultPrin,'MONTO')), 2, ",", ".")."</td></tr>";
...
//$tasas = $res2[0]["pie_pag"];
 ...
 <tr>
     ...
     <br>Total '.$res[0]["simbolo"].':'.number_format($res[0]["total"], 2, ",", ".").' ('.$MTO_LETRA.')'.'
     <br>'.$Bs.'
     </td>
     <td style="font-size:11px;" width="40%">
         <table >
             <tr>
                 <td style="font-size:11px;" align="right"> Subtotal '.$res[0]["simbolo"].': </td>
                 <td style="font-size:11px;" align="right">'.number_format($res[0]["sub_total"], 2, ",", ".").' </td>
             </tr>
             <tr >
                 <td style="font-size:11px;" align="right"> Base Imponible '.$res[0]["simbolo"].': </td>
                 <td style="font-size:11px;" align="right">'.number_format($res[0]["monto_gravado"], 2, ",", ".").'</td>
             </tr>
             <tr>
                 <td style="font-size:11px;" align="right"> Monto Exento '.$res[0]["simbolo"].': </td>
                 <td style="font-size:11px;" align="right">'.number_format($res[0]["monto_nogravado"], 2, ",", ".").' </td>
             </tr>
             <tr>
                 <td style="font-size:11px;" align="right"> IVA '.$res[0]["simbolo"].': </td>
                 <td style="font-size:11px;" align="right">'.number_format($res[0]["monto_iva"], 2, ",", ".").' </td>
             </tr>
             <tr >
                 <td style="font-size:11px;" align="right" > TOTAL FACTURA '.$res[0]["simbolo"].': </td>
 ...
 <tr>
     <td style="font-size:11px;" colspan="2"><br>Elaborado por: '.$res[0]["usuario_genera"].'<br><br>'.$res[0]["pie_pag"].'</td>
 </tr>
</table>
