...
$moneda = $_POST["moneda"];
	 ...
	 $vSQL="EXEC [dbo].[SP_BANCO_INTER_LISTADO] $ID_LOCALIDAD,'$moneda'";
	...
	$vSQL="EXEC [dbo].[SP_BANCO_INTERMEDIARIO_LISTADO] '$moneda'";
	...
	$MSJ_ERROR=$ResultadoEjecutar["MSJ_ERROR"];
	$resultPrin=$ResultadoEjecutar["RESULTADO"];
	$Arreglo["COMBO2"]='<option value="">Seleccione...</option>';
	...
	{		
        ...
        {		
			...
			$Arreglo["COMBO2"]	=$Arreglo["COMBO2"]."<option value=".$ID.">$NB </option>";
			$Arreglo["CONEXION"]=$CONEXION;
			$Arreglo["ERROR"]=$ERROR;
