...
<tr>
     ...
     <div align="center"> 
      ...
      <td style = "text-align: center;">
          <h4>NRO. FACTURA: '.$res_cab[0]["nro_documento"].' NRO. CONTROL: '.$res_cab[0]["nro_control"].'</h4>
      </td>
 </tr>
 <tr>
     <td style = "text-align: center;">
        <h4>SERIE.:'.$res_cab[0]["nb_serie"].' ('.$res_cab[0]["nb_localidad"].')</h4>
    </td>
 </tr>
  <tr>
     <td style = "text-align: center;">
        <h4>CONDICION DE PAGO:'.$res_cab[0]["nb_condicion_pago"].'</h4>
    </td>
 </tr>
</table>
...
<div align="center">
     Fecha Impresión: {DATE j/m/Y h:i A}
</div>
