		...
		<script>		
			...
			{				
				...
				$.ajax(
				{
					type: "POST",
					dataType:"html",
					url: "Sistema/Talonario/FiltroConsulta.PHP",			
					data: Parametros,
					beforeSend: function() 
					{
			...
			function callFormRegistrar(){
				...
				vModal('Sistema/Talonario/FormNuevo.php', 'Registrar Talonario');
			}
			...
			function callFormModificar(ID)
			{
				...
				window.parent.parent.Cargando(1);
				vModal('Sistema/Talonario/FormModificar.php?&ID='+ID+'', 'Modificar Talonario');
			}	

			function anular(ID) {
				swal({
					title: "¿Estas seguro?",
					text: "Estas seguro de anular este Talonario!",
					type: "warning",
					...
					$.ajax({
						type: "POST",
						dataType:"html",
						url: "Sistema/Talonario/ScriptAnular.php",			
						data: parametros,
						beforeSend: function(){
							window.parent.parent.Cargando(1);
						},							
