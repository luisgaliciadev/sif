<?php 
	...
	$vSQL="SELECT * FROM VIEW_TB_TALONARIO_LISTADO WHERE ID='$ID'";	
    ...
    <body class="hold-transition skin-blue sidebar-mini">
    	<form id="vForm">
            ...
            <div class="form-group">
                ...
                <input id="NB_SERIE" type="text" class="form-control" required value="<?php echo $NB;?>">
            </div>
        ...
        <script>
			...
			{	                					
				...
				$.ajax(
				{
					type: "POST",
					dataType:"html",
					url: "Sistema/Talonario/ScriptModificar.PHP",			
					data: Parametros,	
					beforeSend: function() 
					{
