...
$observacion = $_POST["observacion"];
	...
	$vSQL="EXEC dbo.[SP_INSERTAR_MOVIMIENTO_TRANS_INTER_FA] '$documento','$id_moneda','$moneda','$cta_recaudadora','$tp_mov','$cta_intermediaria','$fecha','$referencia','$fecha_inter','$observacion',$monto,$monto_usado,$ID_USER";
