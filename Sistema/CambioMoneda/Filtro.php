		...
		<script>		
			...
			{				
				...
				$.ajax(
				{
					type: "POST",
					dataType:"html",
					url: "Sistema/CambioMoneda/FiltroConsulta.PHP",			
					data: Parametros,
					beforeSend: function() 
					{
			...
			function callFormRegistrar(){
				...
				vModal('Sistema/CambioMoneda/FormNuevo.php', 'Registrar Moneda Referencia');
			}
			...
			function callFormModificar(ID)
			{
				...
				window.parent.parent.Cargando(1);
				vModal('Sistema/CambioMoneda/FormModificar.php?&ID='+ID+'', 'Modificar Moneda Referencia');
			}	

			function anular(ID) {
				swal({
					title: "¿Estas seguro?",
					text: "Estas seguro de anular esta Referencia!",
					type: "warning",
					...
					$.ajax({
						type: "POST",
						dataType:"html",
						url: "Sistema/CambioMoneda/ScriptAnular.php",			
						data: parametros,
						beforeSend: function(){
							window.parent.parent.Cargando(1);
						},							
