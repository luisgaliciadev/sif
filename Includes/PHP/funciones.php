...
$_SESSION[$_SESSION['SISTEMA_SIGLA'] . 'SISTEMA_TEMA_SKIN'] = 'md-skin'; // 'md-skin', ''
...
$_SESSION[$_SESSION['SISTEMA_SIGLA'] . 'SISTEMA_NB'] = 'SSP';
$_SESSION[$_SESSION['SISTEMA_SIGLA'] . 'SISTEMA_NB_LOGO'] = '<b>SSP</b>';
...
function Conectar2()
{
	...
	$NB_SERVERNAME = $_SESSION[$_SESSION['SISTEMA_SIGLA'] . 'NB_SERVERNAME'];
	$NBDB = $_SESSION[$_SESSION['SISTEMA_SIGLA'] . 'NBDB'];
	$ACCES_USER = $_SESSION[$_SESSION['SISTEMA_SIGLA'] . 'ACCES_USER'];
	$PASS_USER = $_SESSION[$_SESSION['SISTEMA_SIGLA'] . 'PASS_USER'];
...
function Conectar3()
{
	...
	$NB_SERVERNAME = $_SESSION[$_SESSION['SISTEMA_SIGLA'] . 'NB_SERVERNAME3'];
	$NBDB = $_SESSION[$_SESSION['SISTEMA_SIGLA'] . 'NBDB3'];
	$ACCES_USER = $_SESSION[$_SESSION['SISTEMA_SIGLA'] . 'ACCES_USER3'];
	$PASS_USER = $_SESSION[$_SESSION['SISTEMA_SIGLA'] . 'PASS_USER3'];
